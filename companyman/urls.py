...
urlpatterns = [
    ...
    path('espace_compagnie_manager/<int:comp_id>/', views.espace_compagnie_manager, name='espace_compagnie_manager'),
    path('espace_compagnie_agent/<int:comp_id>/', views.espace_compagnie_agent, name='espace_compagnie_agent'),
